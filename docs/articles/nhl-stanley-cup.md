...
> **Note on the conference format.** The real Stanley Cup format runs
> the Eastern and Western conference brackets in parallel and merges
> their winners into the Final. Merging from multiple upstream stages
> into one downstream stage is a planned feature not yet available in
> this version. This vignette models a simplified bracket where all 16
> teams compete in one seeded tree.
...
For simulation or bulk data entry,
